...
1. **Attendance Database**
   ...
   This database contains the attendance record of LegCo Council and committee open meetings since the
   sixth term.
...
LegCo APIs have a limit of 1000 requests per IP per hour. Once the limit is reached, you will not be able to retrieve 
any data for awhile. If you run into the following error message while pretty sure you have the correct parameters, 
